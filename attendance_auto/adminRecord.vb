...
Public Class adminRecordMain
    ...
    Private Sub Guna2Button4_Click(sender As System.Object, e As System.EventArgs) Handles adminSave.Click
        ...
        ElseIf rolecombobox.SelectedValue Is Nothing OrElse statuscombobox.SelectedValue Is Nothing Then
            MessageBox.Show("Please select role, Status, and Programme before saving.", "Missing Data", MessageBoxButtons.OK, MessageBoxIcon.Warning)

        Else
            If adminCombobox.Text = "SELECT STAFF" Then
                answer = MessageBox.Show("Are you sure you want to save?", "Submit", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                If (answer = DialogResult.Yes) Then
                    If functions.RegistrationemailCheckadmin(emailTxt.Text) Then
    ...
    Private Sub Guna2Button5_Click(sender As System.Object, e As System.EventArgs) Handles Guna2Button5.Click
        ...
        rolecombobox.Text = ""
        statuscombobox.Text = ""
        adminCombobox.Text = "SELECT STAFF"
        pictureBox.Image = Nothing
        captureDevice.SignalToStop()
    End Sub

    Private Sub adminRecordMain_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        loadAdminComboboxes()
    ...
    Private Sub adminCombobox_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles adminCombobox.SelectedIndexChanged
